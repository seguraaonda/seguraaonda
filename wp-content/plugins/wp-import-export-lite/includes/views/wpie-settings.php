                            ...
                            <form class="wpie_user_role_frm">
                                <div class="wpie_setting_element_only_data">
                                    ...
                                    <div class="wpie_import_cap_wrapper">
                                        ...
                                        <div class="wpie_import_cap_container">
                                            <input type="checkbox" class="wpie_checkbox wpie_manage_export wpie_user_cap wpie_manage_export" id="wpie_cap_manage_export" name="wpie_cap_manage_export" value="1"/>
                                        ...
                                        <div class="wpie_import_cap_container">
                                            <input type="checkbox" class="wpie_checkbox wpie_settings" wpie_user_cap id="wpie_cap_settings" name="wpie_cap_settings" value="1"/>
