...
class WPIE_Taxonomy extends \wpie\import\engine\WPIE_Import_Engine {
    ...
    public function process_import_data() {
        ...
        if ($this->is_update_field("description")) {
            ...
            $this->wpie_final_data['description'] = wpie_sanitize_field($this->get_field_value('wpie_item_term_description'));
        }
        ...
        if ($this->is_update_field("parent")) {
            ...
            $parent = wpie_sanitize_field($this->get_field_value('wpie_item_term_parent'));
