...
class WPIE_CSV_Chunk extends \wpie\import\chunk\WPIE_Chunk
{
        ...
        public function process_csv( $fileDir = "", $file_name = "", $baseDir = "", $wpie_csv_delimiter = ",", $wpie_xml_fileName = "", $is_new_request = 0, $is_first_row_title = 1 )
        {
                ...
                if( intval( $is_new_request ) === 1 || empty( $wpie_csv_delimiter ) )
                {
