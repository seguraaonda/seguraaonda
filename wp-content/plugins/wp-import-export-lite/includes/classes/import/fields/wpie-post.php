                        ...
                        <div class="wpie_field_mapping_container_element">
                            ...
                            <div class="wpie_image_option_wrapper">
                                <div class="wpie_field_mapping_radio_input_wrapper wpie_image_media_option_data">
                                    <input type="checkbox" id="wpie_item_search_existing_images" name="wpie_item_search_existing_images" checked="checked" value="1" class="wpie_checkbox wpie_search_existing_images">
...
if (!function_exists("wpie_import_post_update_existing_item_fields")) {
        ...
        function wpie_import_post_update_existing_item_fields($sections = "", $wpie_import_type = "") {
                ...
                ?>
                <div class="wpie_field_mapping_container_element">
                    <div class="wpie_field_mapping_inner_title"><?php esc_html_e('Update Existing items data', 'wp-import-export-lite'); ?></div>
                    <div class="wpie_field_mapping_other_option_wrapper">
                    ...
                    <div class="wpie_field_mapping_other_option_wrapper">
                        ...
                        <div class="wpie_radio_container">
                            ...
                            <div class="wpie_field_mapping_other_option_wrapper">
                                <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_title" checked="checked" name="is_update_item_title" id="is_update_item_title" value="1"/>
                            ...
                            <div class="wpie_field_mapping_other_option_wrapper">
                                <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_slug" checked="checked" name="is_update_item_slug" id="is_update_item_slug" value="1"/>
                            ...
                            <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <label for="is_update_item_content" class="wpie_checkbox_label"><?php esc_html_e('Content', 'wp-import-export-lite'); ?></label>
                            </div>
                            <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <label for="is_update_item_excerpt" class="wpie_checkbox_label"><?php esc_html_e('Excerpt', 'wp-import-export-lite'); ?></label>
                            </div>
                            <div class="wpie_field_mapping_other_option_wrapper">
                            ...
                            <div class="wpie_field_mapping_other_option_wrapper">
                                <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_order" checked="checked" name="is_update_item_order" id="is_update_item_order" value="1"/>
                            ...
                            <div class="wpie_field_mapping_other_option_wrapper">
                                <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_post_type" checked="checked" name="is_update_item_post_type" id="is_update_item_post_type" value="1"/>
                            ...
                            ?>
                            <div class="wpie_field_mapping_other_option_wrapper">
                                <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_comment_status" checked="checked" name="is_update_item_comment_status" id="is_update_item_comment_status" value="1"/>
                                <label for="is_update_item_comment_status" class="wpie_checkbox_label"><?php echo esc_html($commnet_status); ?></label>
                            </div>
                            <div class="wpie_field_mapping_other_option_wrapper">
                                <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_ping_status" checked="checked" name="is_update_item_ping_status" id="is_update_item_ping_status" value="1"/>
                                <label for="is_update_item_ping_status" class="wpie_checkbox_label"><?php esc_html_e('Ping Status', 'wp-import-export-lite'); ?></label>
                            </div>
                            <div class="wpie_field_mapping_other_option_wrapper">
                                <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_attachments" checked="checked" name="is_update_item_attachments" id="is_update_item_attachments" value="1"/>
                            ...
                            <?php if ($wpie_import_type == "product") { ?>
                                    <div class="wpie_field_mapping_other_option_wrapper">
                                        <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_product_type" checked="checked" name="is_update_item_product_type" id="is_update_item_product_type" value="1"/>
                                        <label for="is_update_item_product_type" class="wpie_checkbox_label"><?php esc_html_e('Product Type', 'wp-import-export-lite'); ?></label>
                                    </div>
                                    <div class="wpie_field_mapping_other_option_wrapper">
                                        <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_catalog_visibility" checked="checked" name="is_update_item_catalog_visibility" id="is_update_item_catalog_visibility" value="1"/>
                                    ...
                                    <div class="wpie_field_mapping_other_option_wrapper">
                                        <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_featured_status" checked="checked" name="is_update_item_featured_status" id="is_update_item_featured_status" value="1"/>
                                    ...
                                    <div class="wpie_field_mapping_other_option_wrapper">
                                        <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_attributes" checked="checked" name="is_update_item_attributes" id="is_update_item_attributes" value="1"/>
                            ...
                            <?php } ?>
                            <div class="wpie_field_mapping_other_option_wrapper">
                                <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_images" checked="checked" name="is_update_item_images" id="is_update_item_images" value="1"/>
                            ...
                            <div class="wpie_field_mapping_other_option_wrapper">
                                <input type="checkbox" class="wpie_checkbox wpie_item_update_field is_update_item_taxonomies" checked="checked" name="is_update_item_taxonomies" id="is_update_item_taxonomies" value="1"/>
