...
2. Enter 'SVG Flags' (without quotes) in the textbox and click the 'Search Plugins' button.
...
The plugin uses the Alpha-2 code system to indentify individual countries. You can look up the the code for any specific country <a href="https://www.iban.com/country-codes" target="_blank">here</a>.
